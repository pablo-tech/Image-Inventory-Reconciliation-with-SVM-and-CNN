...
#val_loss_list = []
def main():
    global args, best_prec, train_loss_list, val_acc_list, train_acc_list#, val_loss_list
...
#             param.requires_grad = True
    ...
    train_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(args.data, '/home/ubuntu/efs/amazon-bin/code/workspace/sravan-dl/input/counting_train_final.json', transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(args.data, '/home/ubuntu/efs/amazon-bin/code/workspace/sravan-dl/input/counting_test_final.json', transforms.Compose([
            transforms.ToTensor(),
            normalize,
        ])),
