...
img_dir= "/home/ec2-user/SageMaker/efs/amazon-bin/data/bin-images/"
...
if __name__ == '__main__':
    ...
    with open('/home/ec2-user/SageMaker/efs/amazon-bin/input/metadata.json','w') as fp:
        json.dump(metadata,fp)
    print("dumping instances.json...")
    with open('/home/ec2-user/SageMaker/efs/amazon-bin/input/instances.json','w') as fp:
