...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(args.data, '/home/ubuntu/efs/amazon-bin/input/counting_train_corrected.json', transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(args.data, '/home/ubuntu/efs/amazon-bin/input/counting_val.json', transforms.Compose([
            transforms.ToTensor(),
            normalize,
        ])),
