...
#             param.requires_grad = True
    ...
    train_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(args.data, '/home/ubuntu/efs/amazon-bin/code/workspace/sravan-dl/input/counting_train_new.json', transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(args.data, '/home/ubuntu/efs/amazon-bin/code/workspace/sravan-dl/input/counting_val_new.json', transforms.Compose([
            transforms.ToTensor(),
            normalize,
        ])),
